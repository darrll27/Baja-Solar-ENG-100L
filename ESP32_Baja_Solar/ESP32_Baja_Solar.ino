...
void loop() {
  static float settemp = 50;
  static float targettemp = 50; //30 degrees celsius
  static float lastTemperature_1 = 0; // Static variable to store the last known temperature reading from sensor 1
  static float lastTemperature_2 = 0; // Static variable to store the last known temperature reading from sensor 2
